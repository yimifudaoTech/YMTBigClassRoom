...
/// @param roomInfo  教室相关信息
/// @param extraInfo 额外信息
- (void)sendEvent:(NSString *)eventId logType:(QOS_LOGTYPE)logType bussiness:(NSString *)bussiness roomInfo:(NSDictionary *)roomInfo extraInfo:(NSDictionary *)extraInfo;
