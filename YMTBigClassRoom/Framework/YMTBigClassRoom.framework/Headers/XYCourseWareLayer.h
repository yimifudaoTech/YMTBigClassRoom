...
@interface XYCourseWareLayer : UIView
...
@property (nonatomic, strong) XYCourseWareModel *courseWareModel;
@property (nonatomic, strong) HSLargeImageView *largeImageView;
...
//绘制网络图片
- (void)draw_picture:(XYCourseWareModel*)model;

//绘制已经下载好的图片
- (void)drawImage:(UIImage *)image courseModel:(XYCourseWareModel *)model;
